...
new _RevealOnScroll2.default('.TestimonialsContent', '60%');
new _RevealOnScroll2.default('.FeatureItem', '50%');
...
var MobileMenu = function () {
	function MobileMenu() {
		...
		this.menuIcon = (0, _jquery2.default)(".menuIcon");
		this.navigation = (0, _jquery2.default)(".siteMenu");
		this.siteHeader = (0, _jquery2.default)(".headerClass");
		this.events();
	}
...
var RevealOnScroll = function () {
  function RevealOnScroll(cl, val) {
    _classCallCheck(this, RevealOnScroll);

    this.itemsToReveal = (0, _jquery2.default)(cl);
      ...
      this.itemsToReveal.each(function () {
        ...
        new Waypoint({
          ...
          handler: function handler() {
            (0, _jquery2.default)(currentItem).addClass("reveal_show");
          },
...
var StickyHeader = function () {
  function StickyHeader() {
    ...
    this.siteHeader = (0, _jquery2.default)(".headerClass");
    this.headerTrigger = (0, _jquery2.default)(".MainSectionContent_title");
    this.createWaypoints();
    this.pageSections = (0, _jquery2.default)(".page-sectionx");
  ...
  _createClass(StickyHeader, [{
    ...
    value: function addSmoothScrolling() {
      (0, _jquery2.default)('.kick').smoothScroll();
    }
  }, {
        ...
        new Waypoint({
          ...
          handler: function handler(direction) {
            if (direction == "down") {
              ...
              (0, _jquery2.default)('.kick').removeClass("dockColor");
              (0, _jquery2.default)(machinHeadd).addClass("dockColor");
            }
          },
          offset: "18%"
        });
...
var Modal = function () {
  function Modal() {
    ...
    this.closeModalButton = (0, _jquery2.default)(".modal_close");
    this.events();
  }
